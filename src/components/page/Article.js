  ...
  rowDetail(lines) {
    ...
    for (let [index, termArray] of lines.entries()) {
      ...
      if (
        ...
        this.state.endRow - this.state.startRow < 22 &&
        index < 6
      ) {
        if (this.state.recData.indexOf(sentenceStr) !== -1) break
      }
      ...
      if (
        ...
        sentence.push({
          ...
          content: sentenceStr.substring(3, 52).trim(),
          ip: sentenceStr.substring(52, 67).trim(),
...
//    <View style={[styles.commentColorContainer, styles.push]}/>
